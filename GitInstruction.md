...
### Базовые команды для работы с ветками в git.
  
  **git branch** - выводит список всех веток и показывает на какой ветке сейчас находимся

* **git branch** _new branch name_ - добавляет новую ветку

* **git branch -d** _branch name_ - удаляет указанную ветку

* **git checkout** _branch name_ - переходит на другую ветку и редактирует там

* **git merge** _branch name_ - сливает веткии (при этом сливает из _branch name_ в ту ветку, в которой находишься)
