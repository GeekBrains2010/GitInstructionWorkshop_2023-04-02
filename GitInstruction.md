...
Система контроля версий позволяет хранить файлы и их версии изменений для работы в команде, при помощи этой системы можно отслеживать изменения, откатывать работу а так же инспектировать код сокомандников.
