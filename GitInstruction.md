...
В первую очередь система контроля версий необходима для совместной работы команды разработчиков. В процессе работы возникают различные (рабочие и не рабочие) варианты кода. 

Для удобной отладки доработок и корректировки различных веток проекта.
