...
Ветки - это дополнительные возможность внести изменения в проект, не затрагивая основную версию проекта. Ветки нужны для внесения дополнений/изменений в проект, просмотр, сравнение их с главной веткой проекта.

### Базовая работа с ветками в git.

Для того, чтобы содать ветку в репозитории, нужно ввести команду:

    git branch <branch name>

Для просмотра всех веток в репозитории нужно ввести команду:

    git branch

Для перехода в нужную вам ветку введите команду:
...
Помните, что при слиянии изменения перехдят из ветки, которую вы указываете в команде, в ту ветку, в которой вы в данный момент находитесь

Для удаления ветки после слияния из нее данных введите команду:
