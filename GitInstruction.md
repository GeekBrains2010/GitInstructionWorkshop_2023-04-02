...
### Что такое репозиторий и инструкция по созданию локальных репозиториев.
  Репозиторий - это хранилеще, позволяющее отслеживать и фиксировать изменения внутри него. Для создания необходимо прописать команду *git init* в той дериктории, где храняться файлы, которые нужно отслеживать ификсировать изменения. Делается это с помощью команд
  * _git add file_name_. Команда, позволяющяя добавить файл к отслеживанию 
  * _git commit -m "комментарий"_. Команда, позволяющая зафиксировать изменение и добавить комментарий к нему.
