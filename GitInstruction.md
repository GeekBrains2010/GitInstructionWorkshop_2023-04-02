...
<Ветки позволяют вести многовекторное параллельное редактирование файла

1. Для создания ветки нужно ввести в терминале команду git brach <новая ветка>
2. Для перемещения в какую-то ветку следует ввести команду git checkout <имя ветки>
3. Для слияния с текущей веткой данных из другой ветки нужно ввести команду git merge <имя ветки>
