...
Для того, чтобы скачать VSC, необходимо перейти на официальный сайт программы **https://code.visualstudio.com/download**, скачать версию VSC для своей операционной системы. VSCode поддерживает такие ОС как: Windows, Linux, macOS. Далее необходимо запустить установочный файл и следовать инстукциям.
