...
Ветки - это различные версии одного и того же документа. Ветки позволяют работать в команде, т.к. в главной ветке не будут сохранены те изменения, которые сделаны в дрпугой ветке, без их слияния.
