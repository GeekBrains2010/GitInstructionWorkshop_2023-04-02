...
Также будет полезно прочитать [второе руководство](https://git-scm.com/docs/gittutorial-2) и [глоссарий](https://git-scm.com/docs/gitglossary). Они также доступны в виде man-страниц.
