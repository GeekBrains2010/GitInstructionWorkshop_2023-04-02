...
Для просмотра в какой ветке находимся на данный момент нужно ввести команду "git branch"
Для создания новой ветки ввести команду "git branch <имя новой ветки>"
Для перехода на другую ветку ввести команду "git checkout <имя ветки>"
Для слияния двух веток ввести команду "git merge <имя сливаемой ветки>" с ветки, куда надо слить
Для удаления ненужных веток ввести команду "git branch -d <имя удаляемой ветки>"
