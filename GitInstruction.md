...
Ветки - это указатели на коммиты. Нужны для работы в комманде (и не только), чтобы править не "чистовик", а вносить спокойно изменения в "черновике", которые в последствии можно предложить автору репозитория. Работая в ветке, можно не переживать за оригинал проекта, так как на нём это не отражается никак, до того, пока ветки не сольёшь.
